...
#define out_pos_Pin GPIO_PIN_2
#define out_pos_GPIO_Port GPIOC
#define out_neg_Pin GPIO_PIN_3
#define out_neg_GPIO_Port GPIOC
#define bus_1_Pin GPIO_PIN_0
