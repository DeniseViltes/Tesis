...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(Vc_11_GPIO_Port, Vc_11_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, Vc_31_Pin|Vc_32_Pin|Vc_12_Pin|Vc_1_Pin
                          |Vc_2_Pin|Vc_3_Pin|otro_Pin|Vc_21_Pin
  ...
  /*Configure GPIO pin : Vc_11_Pin */
  GPIO_InitStruct.Pin = Vc_11_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Vc_11_GPIO_Port, &GPIO_InitStruct);
